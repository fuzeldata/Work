...
public partial class MasterPage : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (myreader1.HasRows)
        {
            ...
            {
                htmlTable.Append("<li><a href='displaysubcategory.aspx?cid=" + myreader1["catid"].ToString() + "' class='parent'><span>" + myreader1["catname"].ToString() + "</span></a>");
                ...
                if (myreader2.HasRows)
                {
                    ...
                    {
                        htmlTable.Append("<li><a href='displayproducts.aspx?scid=" + myreader2["subcatid"].ToString() + "'><span>" + myreader2["subcatname"].ToString() + "</span></a></li>");
                    }
                    htmlTable.Append("</ul>");
                    htmlTable.Append("</div>");
